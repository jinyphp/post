...
@section('title', '블로그 글 등록')

@section('content')
    <div class="container-fluid">

        <x-heading title="블로그 글 등록" :subtitle="$config['subtitle'] ?? ''">
        ...
        <x-content>
            <x-content-main>
                <form id="blogCreateForm" action="{{ route('admin.cms.blog.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="title" required
                                                    value="{{ old('title') }}" placeholder="블로그 글 제목">
                                                @error('title')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="slug"
                                                    value="{{ old('slug') }}" placeholder="URL 슬러그 (자동 생성)">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="excerpt" rows="3"
                                                    placeholder="글 요약 (자동 생성)">{{ old('excerpt') }}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="file" class="form-control" name="featured_image_file"
                                                    accept="image/*">
                                                <div class="form-text">JPG, PNG, GIF, WebP 형식 · 최대 5MB</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="content" role="tabpanel">
                                    <div class="p-4">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="content" rows="15" required>{{ old('content') }}</textarea>
                                                @error('content')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div id="dropZoneAdmin" class="border border-dashed border-secondary rounded p-4 text-center mb-3"
                                                    ...
                                                    <div id="dropZoneContentAdmin">
                                                        ...
                                                        <p class="small text-muted mt-2 mb-0">
                                                            최대 {{ $config['max_images_per_post'] ?? 10 }}개 · JPG, PNG, GIF, WebP · 각 파일 최대 5MB
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="imagePreviewAdmin" class="mt-3" style="display: none;">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <h6 class="mb-0">선택된 이미지 (<span id="imageCountAdmin">0</span>/{{ $config['max_images_per_post'] ?? 10 }})</h6>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-select" name="status">
                                                    <option value="draft" {{ old('status', $config['default_status'] ?? 'draft') == 'draft' ? 'selected' : '' }}>초안</option>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="allow_comments" id="allow_comments"
                                                        {{ old('allow_comments', $config['enable_comments'] ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="meta_title"
                                                    value="{{ old('meta_title') }}" placeholder="SEO용 제목 (자동 생성)">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="meta_description" rows="3"
                                                    placeholder="SEO용 설명 (자동 생성)">{{ old('meta_description') }}</textarea>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="meta_keywords"
                                                    value="{{ old('meta_keywords') }}" placeholder="키워드 (쉼표로 구분)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <x-content-side>
                ...
                @includeIf("jiny-post::admin.blog.help")
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (blogCreateForm) {
                    blogCreateForm.addEventListener('submit', function(e) {
                        ...
                        console.log('=== Admin 블로그 생성 폼 제출 디버깅 ===');
                ...
                function validateForm() {
                    const title = blogCreateForm.querySelector('input[name="title"]');
                    const content = blogCreateForm.querySelector('textarea[name="content"]');
        ...
        `;
                ...
                function showValidationErrors(errors) {
                    Object.keys(errors).forEach(fieldName => {
                        const field = blogCreateForm.querySelector(`[name="${fieldName}"]`);
                        if (field) {
                            // 기존 오류 메시지 제거
                ...
                function clearValidationErrors() {
                    // 모든 오류 메시지 제거
                    const errorMessages = blogCreateForm.querySelectorAll('.text-danger.small');
                    errorMessages.forEach(msg => msg.remove());

                    // 모든 필드에서 오류 스타일 제거
                    const invalidFields = blogCreateForm.querySelectorAll('.is-invalid');
                ...
                const maxFilesAdmin = {{ $config['max_images_per_post'] ?? 10 }};
