                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('admin.cms.board.list.index') }}">전체 보기</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <td width='200' class="ps-4">
                                    <div class="d-flex gap-2 align-items-center">
                                        <div>
                                            ...
                                            <a href="{{ route('admin.cms.board.posts.index', $item->code) }}" class="text-decoration-none">
