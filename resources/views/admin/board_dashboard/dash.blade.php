        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('admin.cms.board.list.index') }}" class="btn btn-sm btn-light">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('admin.cms.forum.index') }}" class="btn btn-sm btn-light">
                            관리 <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.cms.forum.index') }}" class="btn btn-sm btn-outline-primary">
                            전체보기
                        </a>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.cms.forum.index') }}" class="btn btn-sm btn-outline-danger">
                            전체보기
                        </a>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.cms.board.list.index') }}" class="btn btn-sm btn-outline-success">
                            게시판 관리
                        </a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach($board_stats as $board)
                                        <tr>
                                            <td class="ps-4">
                                                <div>
                                                    <a href="{{ route('admin.cms.board.posts.index', $board->code) }}" class="text-decoration-none">
                                            ...
                                            <td class="text-center pe-4">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <a href="{{ route('admin.cms.board.posts.index', $board->code) }}"
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden position-relative">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <a href="{{ route('admin.cms.board.related.index') }}" class="btn btn-sm btn-primary">
                            관리하기
                        </a>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden position-relative">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <a href="{{ route('admin.cms.board.trend.index') }}" class="btn btn-sm btn-success">
                            관리하기
                        </a>
                    </div>
                </div>
