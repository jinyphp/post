...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center my-3">
        <div>
            <h3><i class="bi bi-gear me-2 text-primary"></i>블로그 설정</h3>
            <p class="text-muted mb-0">블로그 정책과 기본 설정을 관리합니다.</p>
        </div>
        <div>
    ...
    <x-content>
        <x-content-main>
            <x-form-put action="{{ route('admin.cms.blog.config.update') }}">
                <!-- 작성 권한 정책 -->
                <x-card>
                    <x-card-header>
                        <h5 class="mb-0">
                    ...
                    <x-card-body>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <x-switch
                                    name="featured_admin_only"
                                    :checked="$config['policies']['featured_admin_only']['enabled']"
                                >
                    ...
                    <x-card-body>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <x-switch
                                    name="seo_enabled"
                                    :checked="$config['settings']['seo_enabled']"
                                >
                                    <strong>SEO 최적화 활성화</strong>
                                    <div class="text-muted small">메타 태그, 구조화된 데이터 등 SEO 기능을 활성화합니다.</div>
                                </x-switch>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    <div class="text-muted small">블로그 글에 댓글 기능을 활성화합니다.</div>
                                </x-switch>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="small font-monospace text-break">vendor/jiny/post/config/blog.json</div>
                    </div>
                </div>
            </div>
