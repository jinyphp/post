...
/**
 * Forum Configuration Manager
 *
 * 포럼 설정 관리를 위한 서비스 클래스입니다.
 */
class ForumConfigManager
{
    ...
    {
        $this->configPath = __DIR__ . '/../../config/forum.json';
    }
    ...
    protected function getDefaultConfig()
    {
        return [
            'policies' => [
                'admin_write' => ['enabled' => true, 'description' => 'Admin forum write permission'],
                'user_write' => ['enabled' => true, 'description' => 'User forum write permission'],
                'guest_write' => ['enabled' => false, 'description' => 'Guest forum write permission'],
                'user_approval' => ['enabled' => false, 'description' => 'User post approval required'],
                ...
                'allow_anonymous' => ['enabled' => false, 'description' => 'Allow anonymous posting']
            ],
            'settings' => [
    ...
    {
        $descriptions = [
            'admin_write' => 'Admin forum write permission',
            'user_write' => 'User forum write permission',
            'guest_write' => 'Guest forum write permission',
            ...
            'allow_anonymous' => 'Allow anonymous posting'
        ];
