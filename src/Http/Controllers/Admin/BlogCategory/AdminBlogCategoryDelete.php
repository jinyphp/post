...
/**
 * Admin Blog Category Delete Controller
 *
 * 블로그 카테고리 삭제를 처리하는 단일 액션 컨트롤러입니다.
 */
class AdminBlogCategoryDelete extends Controller
{
    /**
     * 테이블명
     */
    ...
    public function __invoke(Request $request, $id)
    {
        ...
        return redirect()->route('admin.cms.blog.category')
            ->with('success', '블로그 카테고리가 삭제되었습니다.');
    }
}